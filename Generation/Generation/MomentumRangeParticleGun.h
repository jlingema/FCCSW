...
class MomentumRangeParticleGun : public GaudiTool , virtual public IParticleGunTool {
 ...
 private:
  ...
  double m_minEta;   ///< Minimum theta angle (Set by options - has priority over theta!)
